  ...
  <div class="">
    <div class="m-5 px-8 py-6 bg-white rounded">      
      <form action="/equipos" method="POST" enctype="multipart/form-data">
        ...
        <div class="container-fluid mx-4 p-4"> 
          ...
          <div class="mt-2">
            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                <input type="text" name="nombre" id="nombre" autocomplete="nombre" required class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Ejemplo: Club de amigos">
        ...
        <div class="container-fluid mx-4 p-4">
          <label for="descripcion" class="block text-sm font-medium leading-6 text-gray-900">Descripción del equipo</label>
          <div class="mt-2">
              <textarea id="descripcion" name="descripcion" rows="2" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Escibe alguna descripción del equipo. Esta información será pública."></textarea>
