...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <h2 class="mx-auto text-3xl font-semibold leading-tight">Equpos</h2>
                ...
                <table class="min-w-full leading-normal">
                    ...
                    <tbody>
                        <?php foreach ($equipos_ligas as $equipo_liga) : ?>
                            <?php 
                                $equipo = $equipos[$equipo_liga['equipo_id']];
                                $liga = $ligas[$equipo_liga['liga_id']];
                            ?>
                            <tr>
                                <td equipo class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                    <div class="flex items-center">
                                        ...
                                        <p class="text-gray-900 whitespace-no-wrap">
                                            <a href="/equipos/show?id=<?php echo $equipo['id']; ?>" class="text-blue-500 hover:underline"><?php echo $equipo['nombre']; ?></a>
                                        </p>
                                        </div>
                                    </div>
                                </td>
                                <td liga>
                                    <p class="text-gray-900 whitespace-no-wrap">
                                        <a href="/ligas/show?id=<?php echo $liga['id']; ?>" class="text-blue-500 hover:underline"><?php echo $liga['nombre']; ?></a>
                                    </p>
                                </td>
                                <td deporte class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
