                ...
                <!-- Listado de equipos participantes -->
                    <div class="container mx-auto px-4 sm:px-8">
                                                        ...
                                                        <div class="flex items-center">
                                                            ...
                                                            <div class="ml-3">
                                                                <p class="text-gray-900 whitespace-no-wrap">
                                                                    <a href="/equipo/show?id=<?=$equipo['id']; ?>" class="text-blue-500 hover:underline"><?=$equipo['nombre']; ?></a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                        ...
                        <!-- TABLA DE SOLICITUDES -->
                            <?php if (isset($usuarioActual) && ($usuario['id'] === $usuarioActual['id'] || isAdmin($usuarioActual))): ?> 
                            <div class="py-6 bg-white rounded grid"> 
                                <div class="container mx-auto rounded">
                                    <div class="py-8">
                                        <h2 class="mx-auto text-3xl font-semibold leading-tight">Solicitudes de acceso a equipos</h2>
                                        <div class="my-2 flex sm:flex-row flex-col items-center justify-between">
                                            <div class="flex flex-row mb-1 sm:mb-0">
                                                <div class="flex flex-row mb-1 sm:mb-0">
                                                    <div class="relative">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <div class="flex items-center">
                                                                        ...
                                                                        <div class="ml-3">
                                                                            <p class="text-gray-900 whitespace-no-wrap">
                                                                                <a href="/equipo/show?id=<?php echo $solicitud['id']; ?>" class="text-blue-500 hover:underline"><?php echo $solicitud['nombre']; ?></a>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <?php switch ($solicitud['solicitud']) {
                                                                        case '0': 
                                                                            echo '
